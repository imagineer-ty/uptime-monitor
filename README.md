...
- Add a web dashboard
- Send email or Discord alerts when a website goes down
- Add Prometheus and Grafana for monitoring

## Project Purpose

This project demonstrates practical DevOps and Cloud Engineering skills by combining application development with containerization, database management, service orchestration, and continuous integration. It simulates a simplified version of commercial uptime monitoring services such as UptimeRobot or Pingdom while showcasing technologies commonly used in production environments.
